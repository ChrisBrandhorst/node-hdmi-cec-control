  ...
  parse: function(message) {
    ...
    switch (obj.type) {
      ...
      case "TRAFFIC":
        ...
        obj.source      = Proto.Device[ obj.header[0] ]
        obj.destination = Proto.Device[ obj.header[1] ]
        obj.messageType = Proto.MessageType[ obj.opcode ] || Proto.MessageType.PollingMessage
